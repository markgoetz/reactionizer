...
function updateScreenLayout() {
	var teams_per_division = Math.ceil(global_teams.length / global_division_count);
	
	$('#divisions').animate({'height': 24 + 26 * teams_per_division}, 'slow');
	$('#division_toolbar').animate({'bottom': 44 + 26 * teams_per_division}, 'slow');
	$('#map').animate({'bottom': 89 + 26 * teams_per_division}, 'slow');
}
